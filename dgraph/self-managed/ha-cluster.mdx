...
- [dgraph-ha.yaml]({variables.repos.dgraph}/blob/master/contrib/config/kubernetes/dgraph-ha/dgraph-ha.yaml)
  file
- Helm charts.
...
3. Install the chart with `<RELEASE-NAME>`:
   ...
   1. You have just deployed Dgraph, version 'v21.12.0'.
       ...
       * Documentation: https://docs.dgraph.io/dgraph
       * Community and Issues: {variables.company.discord}
