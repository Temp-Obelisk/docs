...
**[Dgraph releases]({variables.repos.dgraph}/releases)**. After
...
[Contributing to Dgraph]({variables.repos.dgraph}/blob/main/CONTRIBUTING.md)
or
[Building and running Ratel](https://github.com/dgraph-io/ratel/blob/main/INSTRUCTIONS.md).
