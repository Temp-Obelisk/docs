...
[Docker Compose]({variables.repos.dgraph}/blob/master/contrib/config/docker/docker-compose.yml)
and
[Kubernetes]({variables.repos.dgraph}/tree/master/contrib/config/kubernetes/dgraph-single)
...
We provide sample configuration for both
[Docker Compose]({variables.repos.dgraph}/blob/master/contrib/config/docker/docker-compose-ha.yml)
and
[Kubernetes]({variables.repos.dgraph}/tree/master/contrib/config/kubernetes/dgraph-ha)
