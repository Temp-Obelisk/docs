...
<Note>
  ...
  documentation]({variables.repos.dgraph}/blob/release/v1.0.7/wiki/content/deploy/index.md#tls-configuration).
</Note>
...
- [dgraph4j]({variables.repos.dgraph}4j#creating-a-secure-client-using-tls)
- [dgraph-js]({variables.repos.dgraph}-js/tree/main/examples/tls)
- [dgo]({variables.repos.dgraph}/blob/main/tlstest/acl/acl_over_tls_test.go)
- [pydgraph]({variables.repos.pydgraph}/tree/main/examples/tls)
