...
type NodeState {
  ...
  See : https://docs.dgraph.io/dgraph/self-managed/cluster-setup/.
  """
  group: String
...
type Mutation {
  ...
  See : https://docs.dgraph.io/dgraph/admin/export
  """
  ...
  """
  Start a binary backup.  See : https://docs.dgraph.io/dgraph/enterprise/binary-backups/#create-a-backup
  """
  backup(input: BackupInput!): BackupPayload
  """
  Start restoring a binary backup.  See : https://docs.dgraph.io/dgraph/enterprise/binary-backups/#online-restore
  """
