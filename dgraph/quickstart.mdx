...
We recommend using the official Dgraph Docker image for local development.

In this section we'll run Dgraph locally, then we'll connect to
...
<Steps>
      ...
      <Step title="Connect Ratel">
        ...
        Navigate to the hosted version of Ratel at `https://play.dgraph.io` and enter `http://localhost:8080` for the "Dgraph Conn String".
...
In this quick start we created a new graph instance using Dgraph locally,
...
- Go to [Clients](/dgraph/sdks/overview) to see how to communicate with Dgraph
  from your app.
- Learn how to build intelligent applications using Dgraph

## Need help

- Join the [Dgraph Discord server](https://discord.gg/dgraph) for
