...
<Tip>
  ...
  here]({variables.repos.dgraphnet}). Follow the [install
  instructions]({variables.repos.dgraphnet}#install) to get it up
  and running.
</Tip>
...
[this link]({variables.repos.dgraphnet}#supported-versions).
