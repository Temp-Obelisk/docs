...
<Tip>
  ...
  {variables.repos.dgraphjs}. Follow the [installation
  instructions]({variables.repos.dgraphjs}#install) to get it up
  and running.
</Tip>
...
[this link]({variables.repos.dgraphjs}#supported-versions).

## Quickstart

Build and run the
[simple project]({variables.repos.dgraphjs}/tree/main/examples/simple),
which contains an end-to-end example of using the Dgraph JavaScript client.
Follow the instructions in the
[README]({variables.repos.dgraphjs}/tree/main/examples/simple/README.md)
of that project.

### Examples

- [Simple]({variables.repos.dgraphjs}/tree/main/examples/simple):
  Quickstart example of using dgraph-js.
- [TLS]({variables.repos.dgraphjs}/tree/main/examples/tls):
...
<Tip>
  ...
  example]({variables.repos.dgraphjs}/tree/main/examples/simple)
