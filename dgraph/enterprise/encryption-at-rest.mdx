...
[v20.07.0]({variables.repos.dgraph}/releases/tag/v20.07.0), we
...
[encblog]:
  {variables.company.blog}/encryption-at-rest-dgraph-badger#one-key-to-rule-them-all-many-keys-to-find-them
