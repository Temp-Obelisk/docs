...
|  `--acl_access_ttl` | time.Duration |              `access-ttl` | [string]({variables.repos.ristretto}/blob/main/z/flags.go#L80-L98) |  `alpha`   |                          TTL for the access JWT                          |
| `--acl_refresh_ttl` | time.Duration |             `refresh-ttl` | [string]({variables.repos.ristretto}/blob/main/z/flags.go#L80-L98) |  `alpha`   |                       The TTL for the refresh JWT                        |
...
| `--graphql_poll_interval` | time.Duration |           `poll-interval` | [string]({variables.repos.ristretto}/blob/main/z/flags.go#L80-L98) |  `alpha`   |                 The polling interval for GraphQL subscriptions                 |
