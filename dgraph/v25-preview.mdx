...
releases available for local use. The fastest way to get
started is with Docker.
...
<Note>
  ...
  [Discord]({variables.company.discord}) or
  [GitHub]({variables.repos.dgraph}).
</Note>
...
<Tip>
  ...
  share feedback via [Discord]({variables.company.discord}) or
  [GitHub]({variables.repos.dgraph}).
</Tip>
...
[available in the Dgraph repo]({variables.repos.dgraph}/blob/8a774a03ac2558ad027bd86ead8b0059d3bfa3f5/dgraph/cmd/mcp/prompt.txt).
