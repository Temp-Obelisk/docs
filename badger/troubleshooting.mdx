...
[#293]({variables.repos.badger}/issues/293) and
[#315]({variables.repos.badger}/issues/315).
...
[#436]({variables.repos.badger}/issues/436) and
[#347]({variables.repos.badger}/issues/347).
...
[v2.2007.4]({variables.repos.badger}/releases/tag/v2.2007.4) and
[v3.2103.1]({variables.repos.badger}/releases/tag/v3.2103.1) the
DataDog ZSTD library was replaced by pure Golang version and Cgo is no longer
required. The new library is
backwards compatible in nearly all cases:
